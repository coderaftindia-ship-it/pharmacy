...
--
-- Database: `software_pharmacy22`
--

-- --------------------------------------------------------

--
-- Table structure for table `ds_accounts`
--

CREATE TABLE `ds_accounts` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `ds_account_transaction`
--

CREATE TABLE `ds_account_transaction` (
  `id` int(11) NOT NULL,
  `date` date NOT NULL,
...
--
-- Table structure for table `ds_attached_files`
--

CREATE TABLE `ds_attached_files` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `ds_customers`
--
...
--
-- Table structure for table `ds_doctors`
--

CREATE TABLE `ds_doctors` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `ds_email_logs`
--

CREATE TABLE `ds_email_logs` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `ds_email_template`
--

CREATE TABLE `ds_email_template` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `ds_email_template`
--

INSERT INTO `ds_email_template` (`id`, `template`, `name`, `subject`, `message`, `status`, `last_updated`) VALUES
...
--
-- Table structure for table `ds_expenses`
--
...
--
-- Table structure for table `ds_expense_type`
--

CREATE TABLE `ds_expense_type` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `description` text NOT NULL,
  `other` text NOT NULL,
...
--
-- Table structure for table `ds_login_attempts`
--

CREATE TABLE `ds_login_attempts` (
  `user_id` int(11) NOT NULL,
...
--
-- Table structure for table `ds_media`
--
...
--
-- Dumping data for table `ds_media`
--

INSERT INTO `ds_media` (`id`, `media`, `ext`, `status`, `user_id`, `date_of_joining`) VALUES
...
--
-- Table structure for table `ds_medicines`
--

CREATE TABLE `ds_medicines` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
--
-- Table structure for table `ds_medicine_batch`
--

CREATE TABLE `ds_medicine_batch` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
--
-- Table structure for table `ds_medicine_bill`
--

CREATE TABLE `ds_medicine_bill` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `email` varchar(255) NOT NULL,
...
--
-- Table structure for table `ds_medicine_category`
--

CREATE TABLE `ds_medicine_category` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `date_of_joining` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `ds_medicine_purchase`
--

CREATE TABLE `ds_medicine_purchase` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `ds_menu`
--
...
--
-- Dumping data for table `ds_menu`
--

INSERT INTO `ds_menu` (`id`, `name`, `link`, `icon`, `parent`, `active`, `status`, `priority`) VALUES
...
--
-- Table structure for table `ds_noticeboard`
--

CREATE TABLE `ds_noticeboard` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `ds_payment_method`
--

CREATE TABLE `ds_payment_method` (
  `id` int(5) NOT NULL,
  `name` varchar(100) NOT NULL,
  `description` varchar(255) NOT NULL,
  `other` text NOT NULL,
...
--
-- Table structure for table `ds_salarytemplate`
--

CREATE TABLE `ds_salarytemplate` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `ds_staff_attendance`
--

CREATE TABLE `ds_staff_attendance` (
...
--
-- Table structure for table `ds_staff_payment`
--

CREATE TABLE `ds_staff_payment` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `ds_suppliers`
--
...
--
-- Table structure for table `ds_taxes`
--

CREATE TABLE `ds_taxes` (
  `id` int(11) NOT NULL,
...
INSERT INTO `ds_users` (`user_id`, `user_role`, `user_name`, `firstname`, `lastname`, `email`, `mobile`, `picture`, `address`, `country`, `bloodgroup`, `gender`, `dob`, `salarytemplate_id`, `password`, `temp_hash`, `emailconfirmed`, `status`, `date_of_joining`) VALUES
(1, 1, 'pharmacyadmin', 'Mrinal', 'Kumar', 'phpsoftwarestore@gmail.com', '111111111', 'media-5505453175dbaeecba016c.jpg', '{\"address1\":\"Address Line 1\",\"address2\":\"Address Line 2\",\"city\":\"City\",\"country\":\"Country\",\"postal\":\"411048\"}', NULL, NULL, '', NULL, NULL, '$2y$10$gNywnk6cLBEjVktavfbVy.2oKaM6qvUyDJAGkyAO8flUA71Wr.LIa', '', b'1', 1, '2022-02-10 03:03:34');

-- --------------------------------------------------------

--
-- Table structure for table `ds_user_role`
--
...
--
-- Dumping data for table `ds_user_role`
--

INSERT INTO `ds_user_role` (`id`, `name`, `description`, `permission`, `date_of_joining`) VALUES
...
--
-- Indexes for table `ds_accounts`
--
ALTER TABLE `ds_accounts`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ds_account_transaction`
--
ALTER TABLE `ds_account_transaction`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ds_attached_files`
--
ALTER TABLE `ds_attached_files`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ds_customers`
--
...
--
-- Indexes for table `ds_doctors`
--
ALTER TABLE `ds_doctors`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ds_email_logs`
--
ALTER TABLE `ds_email_logs`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ds_email_template`
--
ALTER TABLE `ds_email_template`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ds_expenses`
--
ALTER TABLE `ds_expenses`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ds_expense_type`
--
ALTER TABLE `ds_expense_type`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ds_invoice`
--
ALTER TABLE `ds_invoice`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ds_items`
--
ALTER TABLE `ds_items`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ds_login_attempts`
--
ALTER TABLE `ds_login_attempts`
  ADD PRIMARY KEY (`user_id`),
  ADD UNIQUE KEY `email` (`email`);

--
-- Indexes for table `ds_media`
--
ALTER TABLE `ds_media`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ds_medicines`
--
ALTER TABLE `ds_medicines`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ds_medicine_batch`
--
ALTER TABLE `ds_medicine_batch`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ds_medicine_bill`
--
ALTER TABLE `ds_medicine_bill`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ds_medicine_category`
--
ALTER TABLE `ds_medicine_category`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ds_medicine_purchase`
--
ALTER TABLE `ds_medicine_purchase`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ds_menu`
--
ALTER TABLE `ds_menu`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ds_noticeboard`
--
ALTER TABLE `ds_noticeboard`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ds_payments`
--
ALTER TABLE `ds_payments`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ds_payment_method`
--
ALTER TABLE `ds_payment_method`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ds_salarytemplate`
--
ALTER TABLE `ds_salarytemplate`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `ds_staff_attendance`
--
ALTER TABLE `ds_staff_attendance`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ds_staff_payment`
--
ALTER TABLE `ds_staff_payment`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `ds_suppliers`
--
ALTER TABLE `ds_suppliers`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ds_taxes`
--
ALTER TABLE `ds_taxes`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `ds_user_role`
--
ALTER TABLE `ds_user_role`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `ds_accounts`
--
ALTER TABLE `ds_accounts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ds_account_transaction`
--
ALTER TABLE `ds_account_transaction`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ds_attached_files`
--
ALTER TABLE `ds_attached_files`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ds_customers`
--
ALTER TABLE `ds_customers`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ds_doctors`
--
ALTER TABLE `ds_doctors`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ds_email_logs`
--
ALTER TABLE `ds_email_logs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ds_email_template`
--
ALTER TABLE `ds_email_template`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `ds_expenses`
--
ALTER TABLE `ds_expenses`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ds_expense_type`
--
ALTER TABLE `ds_expense_type`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ds_invoice`
--
ALTER TABLE `ds_invoice`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ds_items`
--
ALTER TABLE `ds_items`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ds_login_attempts`
--
ALTER TABLE `ds_login_attempts`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ds_media`
--
ALTER TABLE `ds_media`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `ds_medicines`
--
ALTER TABLE `ds_medicines`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ds_medicine_batch`
--
ALTER TABLE `ds_medicine_batch`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ds_medicine_bill`
--
ALTER TABLE `ds_medicine_bill`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ds_medicine_category`
--
ALTER TABLE `ds_medicine_category`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ds_medicine_purchase`
--
ALTER TABLE `ds_medicine_purchase`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ds_menu`
--
ALTER TABLE `ds_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- AUTO_INCREMENT for table `ds_noticeboard`
--
ALTER TABLE `ds_noticeboard`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ds_payments`
--
ALTER TABLE `ds_payments`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ds_payment_method`
--
ALTER TABLE `ds_payment_method`
  MODIFY `id` int(5) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ds_salarytemplate`
--
ALTER TABLE `ds_salarytemplate`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `ds_staff_attendance`
--
ALTER TABLE `ds_staff_attendance`
  MODIFY `id` int(200) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ds_staff_payment`
--
ALTER TABLE `ds_staff_payment`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `ds_suppliers`
--
ALTER TABLE `ds_suppliers`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ds_taxes`
--
ALTER TABLE `ds_taxes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `ds_user_role`
--
ALTER TABLE `ds_user_role`
